...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = "weights/method_ghpa_gab_ca_aspp_res/last_epoch_weights.pth"
    # -----------------------------------------------------#
    ...
    # ------------------------------------------------------------------#
    save_dir = 'weights/method_ghpa_gab_ca_aspp_res'
    # ------------------------------------------------------------------#
    ...
    VOCdevkit_path = 'strawberry_dataset'
    # ------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    from nets.method_ghpa_gab_ca_aspp_res import self_net
    model = self_net(n_classes=num_classes).to(device)

    if not pretrained:
        #model = torch.load('unet_temp/last_epoch_weights.pth')
        weights_init(model)
    if model_path != '':
        # ------------------------------------------------------#
        #   权值文件请看README，百度网盘下载
