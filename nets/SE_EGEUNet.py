...
class EnCoderBlock(nn.Module):
    def __init__(self,in_channels,out_channels,att=False):
        ...
        self.att_encoder = nn.Sequential(
            ...
            nn.GroupNorm(4,out_channels),
            nn.GELU(),
            SE_Block(inchannel=out_channels),
...
class self_net(nn.Module):
    ...
    def __init__(self, n_classes=4, input_channels=3, c_list=[32,64,128,64,128,256], bridge=True, gt_ds=True):
        super().__init__()
